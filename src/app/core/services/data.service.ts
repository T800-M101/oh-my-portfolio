...
export class DataService {
  ...
  private readonly profile_en = {
    ...
    bachelorsDegree:
      'Bachelor of Engineering in Communication and Information Technologies',
    about:
    ...
    about_2:
      'I like to contribute to the generation of a pleasant work environment. I believe teamwork is the way to go.',
    experience: '6',
  ...
  private readonly profile_es = {
    ...
    education: 'UTCH Chihuahua (2016 - 2019)',
    bachelorsDegree:
      'Ingeniero en Tecnologías de la Comunicación e Información',
    about:
      'Soy un desarrollador web apasionado con 6 años de experiencia creando sitios web y aplicaciones web modernos y adaptables. Soy un desarrollador fullstack. Tengo experiencia con tecnologías frontend y back-end. Mi enfoque combina conocimientos técnicos con una visión de diseño para ofrecer soluciones funcionales y visualmente atractivas.',
    about_2:
      'Me gusta contribuir a la creación de un ambiente de trabajo agradable. Creo que el trabajo en equipo es fundamental.',
    experience: '6',
    linkedin: 'https://www.linkedin.com/in/guillermo-moran-8290b0106/',
    github: 'https://github.com/T800-M101/oh-my-portfolio',
    portfolio: 'https://oh-my-portfolio.netlify.app/',
 ...
 coreStack: [
  ...
  private readonly skills_en = [
    ...
    },
    {
      name: 'Node JS',
      description:
        'Server-side Javascript, REST API´s, Express, functional programming',
      id: 4,
    },
    {
      name: 'Nest JS',
      description:
        'Skilled, in building scalable server-side applications using modular architecture. Experience with middleware, microservices and database integration.',
      id: 5,
    },
    {
      name: 'TypeORM',
      description:
        'Used extensively in backend development with NestJS to define entities, manage database relations, and perform queries in PostgreSQL. Familiar with repositories and eager/lazy loading strategies.',
      id: 6,
    },
    {
      name: 'Python',
      description:
        'Skilled in building scalable microservices using Python, with experience in designing RESTful APIs, asynchronous processing, and containerized deployments.',
      id: 7,
    },
    {
      name: 'Flask',
      description:
        'Proficient in developing lightweight and scalable microservices using Flask, leveraging its simplicity and flexibility to build RESTful APIs.',
      id: 8,
    },
    { name: 'Databases', description: 'MongoDB, SQL', id: 9 },
  ];
  ...
  private readonly skills_es = [
    ...
    },
    {
      name: 'Node JS',
      description:
        'Javascript del lado del servidor, API REST, Express, programación funcional',
      id: 4,
    },
    {
      name: 'Nest JS',
      description:
        'Experiencia en la creación de aplicaciones escalables del lado del servidor mediante arquitectura modular y middleware, microservicios e integración de bases de datos.',
      id: 5,
    },
    {
      name: 'TypeORM',
      description:
        'Uso extensivo en el desarrollo backend con NestJS para definir entidades, gestionar relaciones en la base de datos y realizar consultas en PostgreSQL. Familiarizado con el uso de repositorios y estrategias de carga eager/lazy.',
      id: 6,
    },
    {
      name: 'Python',
      description:
        'Experiencia en la creación de microservicios escalables utilizando Python, con experiencia en el diseño de API RESTful, procesamiento asincrónico e implementaciones en contenedores.',
      id: 7,
    },
    {
      name: 'Flask',
      description:
        'Experiencia en el desarrollo de microservicios livianos y escalables utilizando Flask, aprovechando su simplicidad y flexibilidad para construir API RESTful.',
      id: 8,
    },
    { name: 'Bases de datos', description: 'MongoDB, SQL', id: 9 },
  ];
  ...
  private readonly projects_en = [
    {
      ...
      description:
        'Collection of technical challenges solved with Angular. Each one shows the problem, the solution, and the design decisions.',
      techs: [
        { name: 'Angular Forms', id: 0 },
        { name: 'RXJS', id: 1 },
        { name: 'Tailwind', id: 2 },
      ],
    ...
    {
      id: 2,
      name: 'CSS Grid Patterns',
      description:
        'Project focused on building modern layout patterns using CSS Grid and Vue 3. Includes reusable and responsive examples such as Holy Grail, RAM Pattern, and Full Bleed.',
      techs: [
        { name: 'Vue 3', id: 0 },
        { name: 'CSS Grid', id: 1 },
        { name: 'Vite', id: 2 },
        { name: 'Vue Router', id: 3 },
      ],
      photo: '/assets/css-grid-layout.webp',
  ...
  private readonly projects_es = [
    {
      ...
      description:
        'Recopilación de desafíos técnicos resueltos con Angular. Cada uno muestra el problema, la solución y las decisiones de diseño.',
      techs: [
        { name: 'Angular Forms', id: 0 },
        { name: 'RXJS', id: 1 },
        { name: 'Tailwind', id: 2 },
    ...
    },
    {
      ...
      name: 'CSS Grid Patterns',
      description:
        'Proyecto enfocado en la creación de patrones de layout modernos utilizando CSS Grid y Vue 3. Incluye ejemplos reutilizables y responsive como Holy Grail, RAM Pattern y Full Bleed.',
      techs: [
        { name: 'Vue 3', id: 0 },
        { name: 'CSS Grid', id: 1 },
        { name: 'Vite', id: 2 },
